...
import type { Facility, Building, Zone, CreateFacilityData, UpdateFacilityData, CreateBuildingData, UpdateBuildingData, CreateZoneData, UpdateZoneData } from '../../admin/types';
...
export const OrganizationManagementPage: React.FC = () => {
  ...
  const handleSubmitFacility = async (data: CreateFacilityData | UpdateFacilityData) => {
    try {
      ...
      console.error(`Failed to ${modalMode} facility`, error);
      throw error;
    }
  };
  ...
  const handleSubmitBuilding = async (data: CreateBuildingData | UpdateBuildingData) => {
    try {
      ...
      console.error(`Failed to ${modalMode} building`, error);
      throw error;
    }
  };
  ...
  const handleSubmitZone = async (data: CreateZoneData | UpdateZoneData) => {
    try {
      ...
      console.error(`Failed to ${modalMode} zone`, error);
      throw error;
    }
  };
