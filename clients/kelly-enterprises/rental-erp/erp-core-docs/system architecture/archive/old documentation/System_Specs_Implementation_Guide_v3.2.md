# Fireproof Gauge System — System Specifications (Implementation Guide for AI)

**Version:** 3.2  
**Date:** 2025‑08‑23  
**Scope:** Business & UX behaviors expressed as implementable requirements for any AI coding assistant (Claude, Cursor, GPT, Copilot).  
**Related Docs:**  
- Technical Architecture – Developer Playbook (modules/events/folders)  
- Database & Permissions – Schema Reference (tables, seeds, regex, queries)
